...
if ( !function_exists( 'handyman_services_template_related_theme_setup' ) ) {
	add_action( 'handyman_services_action_before_init_theme', 'handyman_services_template_related_theme_setup', 1 );
	function handyman_services_template_related_theme_setup() {
		handyman_services_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'handyman-services'),
		...
		handyman_services_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'handyman_services_template_related_output' ) ) {
	function handyman_services_template_related_output($post_options, $post_data) {
