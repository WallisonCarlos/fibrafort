...
if ( !function_exists( 'handyman_services_template_portfolio_theme_setup' ) ) {
	add_action( 'handyman_services_action_before_init_theme', 'handyman_services_template_portfolio_theme_setup', 1 );
	function handyman_services_template_portfolio_theme_setup() {
		handyman_services_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image', 'handyman-services'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		));
		handyman_services_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image', 'handyman-services'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		handyman_services_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image', 'handyman-services'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		handyman_services_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h' 	 => 209
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 209
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 209
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h' 	 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h' 	 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h' 	 => 370
		));
		handyman_services_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h' 	 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		handyman_services_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'handyman-services'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'handyman-services'),
			'w'		 => 370,
			'h'		 => 370
		));
		// Add template specific scripts
		add_action('handyman_services_action_blog_scripts', 'handyman_services_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('handyman_services_template_portfolio_add_scripts')) {
	//add_action('handyman_services_action_blog_scripts', 'handyman_services_template_portfolio_add_scripts');
	function handyman_services_template_portfolio_add_scripts($style) {
		if (handyman_services_substr($style, 0, 10) == 'portfolio_' 
			|| handyman_services_substr($style, 0, 5) == 'grid_' 
			|| handyman_services_substr($style, 0, 7) == 'square_' 
			|| handyman_services_substr($style, 0, 6) == 'short_'
			|| handyman_services_substr($style, 0, 6) == 'alter_' 
			|| handyman_services_substr($style, 0, 8) == 'colored_') {
			handyman_services_enqueue_script( 'isotope', handyman_services_get_file_url('js/jquery.isotope.min.js'), array(), null, true );
			if ($style != 'colored_1')  {
...
// Template output
if ( !function_exists( 'handyman_services_template_portfolio_output' ) ) {
	function handyman_services_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
				...
				<<?php echo trim($tag); ?> class="post_item post_item_colored post_item_colored_1
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							$new = handyman_services_get_custom_option('mark_as_new', '', $post_data['post_id'], $post_data['post_type']);					// !!!!!! Get option from specified post
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'handyman-services'); ?></div><?php
							}
							?>
						</div>
						...
						<div class="post_description clearfix">
							...
							if ($post_data['post_type'] == 'matches'){
								...
								echo '<div class="match_date">'
										. (!empty($post_meta['match_date']) && !handyman_services_param_is_inherit($post_meta['match_date']) ?  date("d M", strtotime($post_meta['match_date'])) : '')
										. (!empty($post_meta['match_time']) && !handyman_services_param_is_inherit($post_meta['match_time']) ?  ' ' . trim($post_meta['match_time']) : '')
									.'</div>';
								?>
							...
							if ($post_data['post_type'] == 'players'){
								...
								echo '<div class="player_info">'
										. (!empty($post_meta['player_country']) && !handyman_services_param_is_inherit($post_meta['player_country']) ? '<span class="player_country">'. esc_html__( 'Country: ', 'handyman-services' ) .''. handyman_services_get_list_countries(false,$post_meta['player_country']) . '</span>' : '')
										. (!empty($post_meta['player_club']) && !handyman_services_param_is_inherit($post_meta['player_club']) ? '<span class="player_club">'. esc_html__( 'Club: ', 'handyman-services' ) .''. trim($post_meta['player_club']) .'</span>' : '')
										. (!empty($post_meta['player_age']) && !handyman_services_param_is_inherit($post_meta['player_age']) && $post_meta['player_type'] == 'player' ? '<span class="player_age">'. esc_html__( 'Age: ', 'handyman-services' ) .''. trim($post_meta['player_age']) .'</span>' : '')
									.'</div>';
							}
							...
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(handyman_services_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'handyman-services'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', handyman_services_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = handyman_services_get_resized_image_tag($post_data['post_attachment'], 
					 ...
					 ?>">
						...
						if ($style!='colored') {
							...
							<div class="post_info_wrap info"><div class="info-back">
								...
								<?php
								if ($show_title) {
									?><h3 class="post_title"><?php echo trim($link_start) . trim($post_data['post_title']) . trim($link_end); ?></h3><?php
								}
								?>
									...
									if ($post_data['post_protected']) {
										...
										if ($post_data['post_excerpt']) {
											echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) 
												...
												: '<p>' . ($link_start) 
													. (handyman_services_strpos($post_options['hover'], 'square')!==false
														? strip_tags($post_data['post_excerpt'])
														: trim(handyman_services_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : handyman_services_get_custom_option('post_excerpt_maxlength_masonry'))) 
														)
													. ($link_end) . '</p>';
										}
