...
<a href="#" class="top_panel_cart_button" data-items="<?php echo esc_attr($cart_items); ?>" data-summa="<?php echo esc_attr($cart_summa); ?>">
	...
	<span class="contact_label contact_cart_label"><?php esc_html_e('Your cart:', 'handyman-services'); ?></span>
	<span class="contact_cart_totals">
		<span class="cart_items"><?php
			echo esc_html($cart_items) . ' ' . ($cart_items == 1 ? esc_html__('Item', 'handyman-services') : esc_html__('Items', 'handyman-services'));
		?></span>
		- 
...
<ul class="widget_area sidebar_cart sidebar"><li>
	...
	handyman_services_storage_set('current_sidebar', 'cart');
