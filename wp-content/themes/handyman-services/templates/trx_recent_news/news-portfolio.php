...
if ( !function_exists( 'handyman_services_template_news_portfolio_theme_setup' ) ) {
	add_action( 'handyman_services_action_before_init_theme', 'handyman_services_template_news_portfolio_theme_setup', 1 );
	function handyman_services_template_news_portfolio_theme_setup() {
		handyman_services_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'handyman-services'),
...
// Template output
if ( !function_exists( 'handyman_services_template_news_portfolio_output' ) ) {
	function handyman_services_template_news_portfolio_output($post_options, $post_data) {
