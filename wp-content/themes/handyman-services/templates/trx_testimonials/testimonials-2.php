...
if ( !function_exists( 'handyman_services_template_testimonials_2_theme_setup' ) ) {
	add_action( 'handyman_services_action_before_init_theme', 'handyman_services_template_testimonials_2_theme_setup', 1 );
	function handyman_services_template_testimonials_2_theme_setup() {
		handyman_services_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'handyman-services')
		));
	}
}

// Template output
if ( !function_exists( 'handyman_services_template_testimonials_2_output' ) ) {
	function handyman_services_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
