...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Handyman Services
	 * @var $inverse	- added by Handyman Services
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Handyman Services:
	// Color scheme
	if ($scheme && !handyman_services_param_is_off($scheme) && !handyman_services_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !handyman_services_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Handyman Services color scheme in the row
	if ($scheme && !handyman_services_param_is_off($scheme) && !handyman_services_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
